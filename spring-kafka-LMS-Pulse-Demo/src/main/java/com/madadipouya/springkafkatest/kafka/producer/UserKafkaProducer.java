...
public class UserKafkaProducer {
    ...
    private final KafkaTemplate<String, PulseRequestModel> kafkaTemplate;
    ...
    public UserKafkaProducer(KafkaTemplate<String, PulseRequestModel> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    //public void writeToKafka(PulseRequestModel user) {
